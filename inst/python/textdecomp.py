...
satzzeichen = [".", "", ",", ":", "!", "?", "·"]
trenner = {"-":1} #silbentrennersymbol
#leidenklammerung = {"[":"im Original beschädigt", "]":"im Original beschädigt",  "(": "im Original augelassen", ")":"im Original augelassen", "<":"Korrektur eines Fehlers aus dem Original",">":"Korrektur eines Fehlers aus dem Original", "{":"im Vergleich zum Original getilgte Worte","}":"im Vergleich zum Original getilgte Worte", "[[":"Rasur","]]":"Rasur"} #editorische Klammerung

#-----------------------buchstaben und bewertungen------------------------------
#lateinische Zeichen / Verwendungen / Bedeutungen im grammatischen System
buchstLAT = {"d":1, "b":1, "g":1, "p":1, "t":1, "c":1, "k":1, "q":1, "qu":1, "ph":1, "th":1, "ch":1, "x":1, "z":1, "f":1, "v":1, "s":1, "m":1, "n":1, "l":1, "r":1, "a":1,"i":2,"e":3,"o":4,"u":5,"v":6, "y":7, "h":1}# liste (array) mit bezeichnern statt Indices
#vokale
vokaleLAT = {"a":1,"i":2,"e":3,"o":4,"u":5,"v":6, "y":7}
#vokalelangLAT = {} #?
#vokalekurzLAT = {} #?
#vokalelangkurzLAT = {} #?
disptongLAT = {"ae":1, "au":1, "eu":1, "oe":1 }
#konsonanten
konLAT = {"d":1, "b":1, "g":1, "p":1, "t":1, "c":1, "k":1, "q":1, "qu":1, "ph":1, "th":1, "ch":1, "x":1, "z":1, "f":1, "v":1, "s":1, "m":1, "n":1, "l":1, "r":1}
doppelkonsonanzLAT = {"x":"ks", "z":"ts"}
doppelabereinzelkonsonantLAT = { "ph":1, "th":1, "ch":1}
labiovelareLAT = {"qu":1, "su":1, "gu":1}
mutacumliquidaLAT = {"dl":1, "gl":1, "pl":1, "tl":1, "cl":1, "kl":1, "ql":1, "dr":1, "gr":1, "pr":1, "tr":1, "cr":1, "kr":1, "qr":1 } #SIND DIE RICHTIG HAB ICH EINFACH SO ANGENOMMEN OHNE BUCH - m und n könnten als quasi liquida dazu kommen
#dauer und hörbarkeit
mutaeLAT = {"d":1, "g":1, "p":1, "t":1, "c":1, "k":1, "q":1, "qu":1, "ph":1, "th":1, "ch":1, "x":1, "z":1}
#dazu
mediaeLAT = {"b":"labial", "d":"dental", "g":"guttural"}
tenuesLAT = {"p":"labial", "t":"dental", "c":"guttural", "k":"guttural", "q":"guttural", "qu":"guttural"}
aspirataeLAT = {"ph":"labial", "th":"dental", "ch":"guttural"}
#dauer und hörbarkeit
dauerlauteLAT = { "f":1, "v":1, "s":1, "m":1, "n":1, "l":1, "r":1}
#dazu
spirantesLAT = {"f":"labial", "v":"labial", "s":"dental"}
nasalesLAT = {"m":"labial", "n":"dental"}
liquidaeLAT = {"l":"dental", "r":"dental"}

#altgriechische Zeichen / Verwendungen
diacriticsunicode = [ "\u0313", "\u0314", "\u0300","\u0301", "\u00B4", "\u02CA", "\u02B9", "\u0342", "\u0308", "\u0304", "\u0306" ]
#buchstGRI = {"α":1, "β": 1, "γ":1, "δ":1, "ε":1, "ζ":1, "η":1, "θ":1, "ι":1, "κ":1, "λ":1, "μ":1, "ν":1, "ξ":1, "ο":1, "π":1, "ρ":1, "σ":1, "ς": 1, "τ":1, "υ":1, "φ":1, "χ":1, "ψ":1, "ω":1}#unvollständig!!!!ἀρχῆς
#schneller weg um das vorhandensein zu checken: print( buchstGRI["α"], buchstGRI["υ"] ), Abfrage if(buchstGRI["α"]), resultiert auch in kürzerem code
vokaleGRI = {"ι":1,"υ":1,"ε":1,"ο":1,"α":1,"ω":1,"η":1}
diphtongGRI = {"αι":1,"υι":1,"οι":1,"ει":1,"αυ":1,"ευ":1,"ου":1,"ηυ":1,"ωυ":1,"ᾳ":1,"ῃ":1,"ῳ":1,"Αι":1,"Ηι":1,"Ωι":1}
vokalelangGRI = {"ω":1,"η":1}
vokalekurzGRI = {"ε":1,"ο":1}
vokalelangkurzGRI = {"α":1,"ι":1,"υ":1}
konGRI = {"β":1, "γ":1, "δ":1, "ζ":1, "θ":1, "κ":1, "λ":1, "μ":1, "ν":1, "ξ":1, "π":1, "ρ":1, "σ":1, "τ":1, "φ":1, "χ":1, "ψ":1}
doppelkonsonanzGRI = {"ξ":"κσ", "ψ":"πσ", "ζ":"σδ"} #richtig so?
doppelabereinzelkonsonantGRI = {}
mutacumliquidaGRI = {"πλ":1, "πρ":1, "πν": 1, "βλ":1, "βρ":1, "φλ":1, "φρ":1, "τλ":1, "τρ":1, "τμ":1, "δρ":1, "δμ": 1, "θλ":1, "θρ":1, "θν":1, "κλ":1, "κρ":1, "κν":1, "γλ":1, "γρ":1, "γν":1, "χλ":1, "χρ":1 } #das wird beim Silbentrennen berücksichtigt nicht bei der Zusammenziehung lautlicher Einheiten
mutaeGRI = {"κ":1, "π":1, "τ":1, "γ":1, "β":1, "δ":1, "χ":1, "φ":1, "θ":1}
meiaeGRI = {"γ":"guttural", "β":"labial", "δ":"dental"}
tenuesGRI = {"κ":"guttural", "π":"labial", "τ":"dental"}
aspirataeGRI = {"χ":"guttural", "φ":"labial", "θ":"dental"}
dauerlauteGRI = { "λ":1, "ρ":1, "μ":1, "ν":1,  "ϝ":1, "σ":1 }
spirantesGRI = {"ϝ":"labial", "σ":"dental"}
nasalesGRI = {"μ":"labial", "ν":"dental"}
liquidaeGRI = {"λ":"dental", "ρ":"dental"}
konsonantengruppenambeginneineswortes = {
'βγ': 1,
'βδ': 65,
'βζ': 1,
'βλ': 597,
...
deklination1stammauslautGRI = {"α":1, "η":1} #???mach ich das so, oder kommt das ins deklinations array???
deklination1endGRI = {"α":["s", "n", "v"], "η":["s","n","v"], "ης":["s","g"], "ας":["s","g"], "ῃ":["s","d"], "ᾳ":["s","d"],"ην":["s","a"], "αι":["p", "n", "v"], "ων":["p","g"], "αις":["p", "d"], "ας":["p","a"]} 
deklination2stammauslautGRI = {"ο":1, "ω":1}
deklination2endGRI = {"ος":["s","n"], "ου":["s","g"], "ῳ":["s","d"], "ον":["s","a"], "ε":["a","v"], "οι":["p","n","v"], "ων":["p","g"], "οις":["p","d"], "ους":["p","a"]}
deklination3stammauslautGRI = {"λ":1, "ρ":1, "κ":1, "γ":1, "χ":1, "π":1, "β":1, "φ":1, "τ":1, "δ":1, "θ":1, "ν":1, "ντ":1, "ος":1, "εσ":1, "ι":1, "υ":1, "ω":1, "ο":1}
deklination3endGRI = {"ς":["s","n"], "ος":["s","g"], "ι":["s","d"], "α":["s","a"], "ες":["p","nv"], "ων":["p","g"], "οι":["p","d"], "οιν":["p","d"], "ας":["p","a"]}

endungennachkasus = { "n": ["α", "η", "αι", "ος", "οι", "ς", "ες"],  
                          "g": ["ης", "ας", "ων", "ου", "ος"], 
...
konjugationVerbaVocaliaVORS = { #vorsilben
    "ἐ": ["LZVsp123"]
}

konjugationVerbaVocaliaVORW = { #vor dem verb stehend optativ konjunktiv
    "ἵνα": ["ZOLFsp123"],
    "εἴθε": ["ZVOLosp123"]
}

konjugationVerbaVocaliaNACHW = { #vor dem verb stehend - unsicher
    "ὦ": ["OLFsp123"],
    "ᾖς": ["OLFsp123"],
    "ᾖ": ["OLFsp123"],
    "ἦτε": ["OLFsp123"], 
...
konjugationVerbaMuta = {
    "":"",                            
}

konjugationVerbaLiquida = {
    "":"",                            
}

#adjektive
komparation = {#adverbien von Adjektiven abgeleitet oder adjektive
    "τερος":[""], #komparativ
    "τέρᾱ":[""], #komparativ
    "τερον":[""], #komparativ
    "τατος":[""], #superlativ
...
demonstrativpronomLAT = { #determinativpronomen scheinen reingemsihct
    "hic": ["snm"],
    "haec": ["snf", "pne", "pae"],
    "hoc": ["sne", "sae", "slm", "sle"],
    "huius": ["sgm", "sgf", "sge"],
...
reflxivpronomenGRI = {} #rückbezügliche Reflexion, von etwas im Text vorher?
reflxivpronomenLAT = {
    "sui":["g"],
    "sibi":["d"],
    "sē":["a", "l"],
...
determinativpronomenGRI = {} #auf jemanden bestimmtes hinweisend
interogativpronomenGRI = { #fragen einleitend
    "τίς":["sn"],
    "τί":["sn", "sa"],
    "τίνος":["sg"],
    "τίνι":["sd"],
...
fktpartikelLAT = { #Verneinung, Hervorhebung, Wunsch, Frage
    "non":[],
    "haud":[],
    "ne":[],
    "quidem":[],
...
partikelGRI = {"δὲ":[""], "δὲ":[""], "δ᾽":[""],"δ'":[""], "ἄν":[""], "γε":[""], "δέ":[""], "δή":[""], "δὴ":[""], "ἐάν":[""], "ἕως":[""], "μήν": [""], "μέν":[""], "μὲν":[""], "μέντοι":[""], "τε":[""], "ἔτι":[""], "οὖν":[""], "ἤ":[""]}

konjuncGRI = {"μέχρι":[], "ὅπως":[], "κὰι":[], "καί": [],  "καὶ":[], "γὰρ":[], "γάρ":[], "ὡς":[], "ὡς":[], "ἢ":[], "ἐπείτε":[], "εἰ":[]}
#kausal konjunktion
...
def ngramWhole( A, n ): #string input, but for more than a word
    if( " " in A  ): #containe spaces
        return ngram( A, n, 0 )
    #add else
...
def ngram( A, n, padding ): #string input
    ...
    if( padding ):
        ...
        adddumm = ["-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-", "-"]
        A = "".join( adddumm[0:n-1] ) + A + "".join( adddumm[0:n-1] )
    #build the gam
    vecA = []
    lele = len(A)-n+1
    for i in range(lele):
...
#SILBEN
def einzeilzeichenzuLauteinheiten( dieeinzelzeichen, diphtong, 
    ...
    buchstaebliches = [] #Einzelzeichen und Diphtonge, Doppelkonsonanz auflösen und qu nicht trennen
    lele = len( dieeinzelzeichen )
    for i in range(1,lele):
        einheit = dieeinzelzeichen[i-1]+dieeinzelzeichen[i]
        
        #print(i, einheit, buchstaebliches, dieeinzelzeichen)
        if( einheit in diphtong ): # ist diphtong
            if(len(buchstaebliches) > 0):
                buchstaebliches.pop()
            buchstaebliches.append( einheit )
        else: # kein Diphtong
            if( einheit in  doppelabereinzelkonsonant ): # ist qu oder ähnliches
                if(len(buchstaebliches) > 0):
                    buchstaebliches.pop()#buchstabe i-1 ist schon drin also wieder raus ist ja auch in der einheit
                buchstaebliches.append( einheit )
            else: # nicht qu
                if( einheit in  mutacumliquida ):
                    if(len(buchstaebliches) > 0):
                        buchstaebliches.pop()#buchstabe i-1 ist schon drin also wieder raus ist ja auch in der einheit
                    buchstaebliches.append( einheit )
                else:
                    if( dieeinzelzeichen[i] in doppelkonsonanz ): #ist doppelkonsonant
                        if( i == 1 ): #ersten Buchstaben mitnehmen
                            buchstaebliches.append(dieeinzelzeichen[i-1])
                        
                        dkeinzeln = list( doppelkonsonanz[ dieeinzelzeichen[i] ] )
                        #print(dkeinzeln)
                        for d in range(len(dkeinzeln)):
                            buchstaebliches.append( dkeinzeln[ d ] )
                        
                    else: #nicht doppelkonsonant -- also einfach zeichen übernhemen
                        #print("doppelkonso", dieeinzelzeichen[i-1], dieeinzelzeichen[i])
                        if( i == 1 ):
                            #print("iiiiiiii", dieeinzelzeichen[i-1], dieeinzelzeichen[i-1] in doppelkonsonanz)
                            #ersten Buchstaben nicht vergessen, und kontrollieren, ob er ein doppelkonsonant
                            
                            if( dieeinzelzeichen[i-1] in doppelkonsonanz ): #ist doppelkonsonant
                                dkeinzeln = list(doppelkonsonanz[dieeinzelzeichen[i-1]] )
                                for d in range(len(dkeinzeln)):
                                    buchstaebliches.append( dkeinzeln[ d ] )
                            else:
                                buchstaebliches.append( dieeinzelzeichen[i-1] )
                            
                            buchstaebliches.append(dieeinzelzeichen[i])
...
def trennSGRInurarray( diewoerter ):
    ...
    '''
    #print(diewoerter)
    ergtext = "" #darin werden die Ergebnisse der Trennung in Silben gespeichert
    for w in range(len(diewoerter)):
        #print(w)
        dieeinzelzeichen = list( diewoerter[ w ]) #zerlege das wort in einzelene Zeichen
        lautliches = einzeilzeichenzuLauteinheiten( dieeinzelzeichen, 
                        diphtongGRI, doppelabereinzelkonsonantGRI, mutacumliquidaGRI, doppelkonsonanzGRI )
        #print( "gr lautliches", lautliches )
        silben = []
        letzteeinheit = False
        for l in range(len(lautliches)):
            istvokalisch = False
            lautlicheeinheit = lautliches[ l ] 
            if( lautlicheeinheit in vokaleGRI or lautlicheeinheit in diphtongGRI ):
                istvokalisch = True
            
            if( istvokalisch ):
                if( letzteeinheit ):
                    #wenn letzteeinheit als gruppe von konsonanten am anfang von worten stehen kann einfach appenden, sonst muß man split machen und aufteilen (letztes an die nächste oder wie)
                    notin = True
                    if( letzteeinheit in konsonantengruppenambeginneineswortes ):
                        if( konsonantengruppenambeginneineswortes[ letzteeinheit ] > 1 ): #was ist wenn es zwei und drei Konsonanten sein könnten  - st und stk
                            silben.append( "-" )
                            silben.append( letzteeinheit )
                            silben.append( lautlicheeinheit )
                            notin = False
                    if(notin):
                        konsos = list(letzteeinheit)
                        ...
                        lkonso = ""
                        if( konsos[len(konsos)-2]+konsos[len(konsos)-1] in mutacumliquidaGRI and len(konsos) >= 2 ):
                            fk = konsos.pop()
                            lkonso = konsos.pop()+fk
                        else:
                            lkonso = konsos.pop() 
                        
                        silben.append( "".join( konsos ) )
                        silben.append( "-" )
                        silben.append( lkonso )
                        silben.append( lautlicheeinheit )
                    letzteeinheit = False
                else:
                    silben.append( "-" )
        ...
        #print(lautliches.toString(), silben.toString())
        ergtext = ergtext + "".join(silben) + "  "
    
    #
    return ergtext
    

def trennSARA(): #Arabisch ?
    print("sara")

def trennSPER(): #Persisch ?
    print("sper")

def trennHEBR(): #Hebräisch ?
    print("heber")
...
def trennSLAT( A ):
    ...
    #    diewoerter = GRvorbereitungT( "u".join(textelem.value.split("v")) ) #holt den Text und spaltet ihn an den Leerzei., nennt das worte
    #} else {
    #    diewoerter = GRvorbereitungT( "u".join( A.split("v")) )
    #}
    diewoerter = textnorm.GRvorbereitungT( textnorm.deluv( A ) )
    ergtext = "" #darin werden die Ergebnisse der Trennung in Silben gespeichert
    for w in range(len(diewoerter)): # für alles was wort bedeuten soll
        dieeinzelzeichen = list( diewoerter[ w ] ) #zerlege das wort in einzelene Zeichen
        lautliches = einzeilzeichenzuLauteinheiten( dieeinzelzeichen, disptongLAT, 
                                                doppelabereinzelkonsonantLAT, mutacumliquidaLAT, doppelkonsonanzLAT )
        #print( "Aus ", dieeinzelzeichen, " wird ", lautliches, "(Lauteinheiten)")
        ...
        lele = len(lautliches)
        for l in range( lele ):
            vorhervokalisch = False
            diesvokalisch = False
            lautlicheeinheit = lautliches[ l ] 
            
            if( lautlicheeinheit in vokaleLAT or lautlicheeinheit in disptongLAT ):
                diesvokalisch = True
            
            if( letzteeinheit in vokaleLAT or letzteeinheit in disptongLAT ):
                vorhervokalisch = True
            
        
            #print("dies vokalisch: ", diesvokalisch, "vorher vokalisch: ", vorhervokalisch,"letzeeinheit:", letzteeinheit, ", diese ", lautlicheeinheit)
            ...
            if( diesvokalisch == True and  vorhervokalisch == True ):  #vokal-vokal uebergang
                ...
                if( letzteeinheit in disptongLAT ): #vokal folgt auf diphton, dann trenne wie im els dieses if blocks - einfach zwei vokale
                    ...
                    silben.append( "-" )
                    silben.append( lautlicheeinheit )
                elif( letzteeinheit+lautlicheeinheit in labiovelareLAT ):#regel 7, gleiche voakle trennenb
                    silben.append( "".join( coda ) )
                    silben.append( "-" )
                    silben.append( letzteeinheit )
                    silben.append( lautlicheeinheit )
                elif( lautliches[l-2]+letzteeinheit in labiovelareLAT ): #regel 5, labiovelare
                    #print("regel 5, labiovelare", silben)
                    nostop = True
                    rest = []
                    while(nostop):
                        curr = silben.pop()
                        if( konLAT[ curr ] or curr == None ):
                            rest.append( curr )
                            nostop = False
                        else:
                            if( trenner[ curr ] == None ):
                                rest.append(curr)
                    ...
                    silben.append( lautlicheeinheit )
                elif( vokaleLAT[ letzteeinheit ] == 5 and #regel u oder v
                           vokaleLAT[ l-2 ] == None and
                           vokaleLAT[ lautlicheeinheit ] != 2):
                    #print("regel u oder v")
                    silben.append( "".join(coda) )
                    silben.append( lautlicheeinheit )
                    #trennung wird dann gemacht beim übergang von konsoant zu vokal
                elif( vokaleLAT[ letzteeinheit ] == 2 and 
                           lautlicheeinheit in vokaleLAT and
                           vokaleLAT[ lautlicheeinheit ] != 4 and
                ...
                coda = []
            elif( diesvokalisch == True and  vorhervokalisch == False ):#konsoant-voakle uebergang
                if(l == 0):
                    silben.append( "-" )
                    silben.append( letzteeinheit )
                else:
                    if( noVokalKonso ):
                        ...
                        letzterkonsoant = coda.pop()
                        silben.append( "".join(coda) )
                        silben.append( "-" )
                        silben.append( letzterkonsoant )
            ...
            elif( diesvokalisch == False and  vorhervokalisch == False ):#konsoant-konsoant uebergang
                #print(lautlicheeinheit)
                coda.append( lautlicheeinheit )
            else: #vokal konsoant uebergang
                coda.append( lautlicheeinheit )
                noVokalKonso = False
                
            letzteeinheit = lautlicheeinheit
        #print(lautliches, silben)
        if( letzteeinheit ): #letzter konsonant
            silben.append( "".join(coda) )
...
def ohneAusKEYS( A, kvlist ): # string input
    bu = list( A.lower() )
    bun = []
    lele = len( bu )
    for b in range( lele ):
        ohnealles = textnorm.delall( bu[b] )
        if( not hasKEY( kvlist, ohnealles ) ):
            bun.append( bu[b] )
    return "".join( bun )
...
-----------------------------------------------------------------------------'''
def iskleineswort( aword ):
    allresu = []
    if( aword in postproGRI ):
        allresu.append([ "postpos", postproGRI[ aword ] ])
    if( aword in postproLAT ):
        allresu.append([ "postpos", postproLAT[ aword ] ])
    if( aword in preposGRI ):
        allresu.append([ "prepos", preposGRI[ aword ] ])
    if( aword in preposLAT ):
        allresu.append([ "prepos", preposLAT[ aword ] ]) 
    if( aword in artikelGRI ):
        allresu.append([ "artikel", artikelGRI[ aword ] ])
    if( aword in perspronomenGRI ):
        allresu.append([ "perspron", perspronomenGRI[ aword ] ])
    if( aword in perspronomenLAT ):
        allresu.append([ "perspron", perspronomenLAT[ aword ] ])
    if( aword in reflxivpronomenGRI ):
        allresu.append([ "refpron", reflxivpronomenGRI[ aword ] ])
    if( aword in reflxivpronomenLAT ):
        allresu.append([ "refpron", reflxivpronomenLAT[ aword ] ])
    if( aword in indefinitpronomenGRI ):
        allresu.append([ "indpron", indefinitpronomenGRI[ aword ] ])
    if( aword in indefinitpronomenLAT ):
        allresu.append([ "indpron", indefinitpronomenLAT[ aword ] ])
    if( aword in negativpronomenGRI ):
        allresu.append([ "negpron", negativpronomenGRI[ aword ] ])
    if( aword in  negativpronomenLAT ):
        allresu.append([ "negpron", negativpronomenLAT[ aword ] ])
    '''
    if( aword in determinativpronomenGRI ):
        allresu.append([ "deterpron", determinativpronomenGRI[ aword ] ])
    '''
    if( aword in determinativpronomenGRI ):
        allresu.append([ "deterpron", determinativpronomenGRI[ aword ] ])
    if( aword in interogativpronomenGRI ):
        allresu.append([ "interopron", interogativpronomenGRI[ aword ] ])
    if( aword in interogativpronomenLAT ):
        allresu.append([ "interopron", interogativpronomenLAT[ aword ] ])
    if( aword in relativpronomenGRI ):
        allresu.append([ "relatpron", relativpronomenGRI[ aword ] ])
    if( aword in reziprokpronomenGRI ):
        allresu.append([ "rezipron", reziprokpronomenGRI[ aword ] ])
    if( aword in otiACIGRI ):
        allresu.append([ "oti", otiACIGRI[ aword ] ])
    if( aword in verneinungpartikelGRI ):
        allresu.append([ "vernein", verneinungpartikelGRI[ aword ] ])
    if( aword in partikelGRI ):
        allresu.append([ "partikel", partikelGRI[ aword ] ])
    if( aword in konjuncGRI ):
        allresu.append([ "konjunktion", konjuncGRI[ aword ] ])
    if( aword in demonstrativpronomGRI ):
        allresu.append([ "demonstpronom", demonstrativpronomGRI[ aword ] ])
    if( aword in demonstrativpronomLAT ):
        allresu.append([ "demonstpronom", demonstrativpronomLAT[ aword ] ])
    if( aword in adverbLAT ):
        allresu.append([ "adverb", adverbLAT[ aword ] ])
    if( aword in korrelativpronomenLAT ):
        allresu.append([ "korrelpron", korrelativpronomenLAT[ aword ] ])
    if( aword in numeraladjektivaLAT ):
        allresu.append([ "numeraladj", numeraladjektivaLAT[ aword ] ]) 
    if( aword in  fktpartikelLAT ):
        allresu.append([ "fktpartikel", fktpartikelLAT[ aword ] ])
    if( aword in interjektionLAT ):
        allresu.append([ "interjektion", interjektionLAT[ aword ] ])
    if( aword in konjunktionSubjunktionLAT ):
        allresu.append([ "konsubjunktion", konjunktionSubjunktionLAT[ aword ] ])
    if( aword in possesivpronLAT ):
        allresu.append([ "possesivp", possesivpronLAT[ aword ] ])
...
def toKKC( A ): #array input
    toret = []  
    lenA = len( A )  
    for a in range( lenA ):
        lenAa = len( A[a] )
        if( 2 < lenAa ):
            splistep = math.floor( lenAa / 3 )
            toret.append( A[a][ 0 : splistep ] )
            toret.append( A[a][ splistep : splistep*2 ] )
            toret.append( A[a][ splistep*2 :len(A[a]) ] )            
        else:
            toret.append( A[a] )
    return toret
...
def toKKCnSufixWords( B ): #B array of "words"
    ...
    lenb = len(B)
    for t in range( lenb ):
        nn.append( toKKCnSufix( B[ t ] ) )
    return nn

def toKKCnSufix( A ): #partitionen (as a terminus technicus from kombinatorik)
    ...
    for h in range( lele ):
        ...
        for z in range( elel ):
            koerper = A[ h : (z+h) ]
            coda = A[ (z+h) : lele ]
            partitionen.append( [ kopf, koerper, coda ] )
        
        
    partitionen.append( [ A, "", "" ] )
    return partitionen
...
def gettransformarray( awordarr ): #words and phrases in this array
    transallALL = []
    lele =  len( awordarr )
    for a in range( lele ):
        transall = []
        ...
        awordlowerd = aword.lower( )   
        transall.append( awordlowerd ) # all lower case

        #KOPF
        #trafsorm first letter A if not Au to Au
        if( awordlowerd[0] == "a" and not ( awordlowerd[1] == "u" )):
            transall.append("av"+awordlowerd[ 1: len( awordlowerd) ])      
               
        #ENDUNGEN
        len1 = len( transall )
        for i in range( len1 ):
            #last o to us
            if( awordlowerd[ len(awordlowerd)-1 ] == "o" ):
                toappend = transall[i][ 0: (len(transall[i])-1) ]+"vs"
                transall.append( toappend )
            
            #last e to non
            elif( awordlowerd[ len(awordlowerd)-1 ] == "e" ):
                toappend = transall[i][ 0 : len(transall[i])-1 ]
                transall.append( toappend )
            
            #last i to us
            elif( awordlowerd[ len(awordlowerd)-1 ] == "i" ):
                toappend = transall[i][ 0 : len(transall[i])-1 ]+"vs"
                transall.append( toappend )
            
            #last er to os
            elif( awordlowerd[ len(awordlowerd)-2 ] == "e" and awordlowerd[ len(awordlowerd)-1 ] == "r"):
                toappend = transall[ i ][ 0 : len(transall[ i ])-2 ]+"ros"
                transall.append( toappend )
            
            #last us to os
            elif( awordlowerd[len(awordlowerd)-2] == "u" and awordlowerd[len(awordlowerd)-1] == "s"):
                toappend = transall[ i ][ 0 : len( transall[ i ])-2 ]+"os"
                #print("toappend", toappend)
                transall.append( toappend )
                toappend = transall[ i ][ 0 : len( transall[ i ])-3 ]+"e"
                transall.append( toappend )
                toappend = transall[ i ][ 0 : len( transall[ i ])-3 ]+"y"
                transall.append( toappend )
                toappend = transall[ i ][ 0 : len( transall[ i ])-1 ]+"o"
                transall.append( toappend )
            
            #last os to us
            elif( awordlowerd[len(awordlowerd)-2] == "o" and awordlowerd[len(awordlowerd)-1] == "s"):
                toappend = transall[ i ][ 0 : len( transall[ i ] )-2 ]+"us"
                transall.append( toappend )
            
        
        #Punktendungen
        if( aword[len(aword)-1] != "." ): #last letter not dot
            #add to all trasformed a dot
            len2 = len( transall )
            for i in range( len2 ):
                transall.append( transall[i] + "." )
        ...
        if( "i" in awordlowerd ): 
            len3 = len( transall )
            for i in range( len3 ):
                transall.append( replaceLastofwith( transall[ i ], "i", toy1 ) )
        ...
        if( "e" in awordlowerd ):
            len4 = len( transall ) 
            for i in range( len4 ):
                transall.append( replaceLastofwith( transall[ i ], "e", toi3 ) )
                transall.append( replaceLastofwith( transall[ i ], "e", toeu2 ) )

        #transform letters o -> u
        if( "o" in awordlowerd ):
            len5 = len( transall ) 
            for i in range( len5 ):
                transall.append( replaceLastofwith( transall[ i ], "o", tou4 ) )
                
        #transform letters o -> i
        if( "o" in awordlowerd ):
            len6 = len( transall ) 
            for i in range( len6 ):
                transall.append( replaceLastofwith( transall[ i ], "o", toi3 ) )
            
        #transform letters u -> o 
        if( "v" in awordlowerd ):
            len7 = len( transall )
            for i in range( len7 ):
                transall.append( replaceLastofwith( transall[ i ], "v", too5 ) )
            
        #transform letters oi -> i
        if( "oi" in range( awordlowerd ) ): 
            len8 = len( transall )
            for i in range( len8 ):
                transall.append( replaceLastofwith( transall[ i ], "oi", toi3 ) )
            
        #transform letters ei -> i
        if( "ei" in awordlowerd ): 
            len9 = len( transall )
            for i in range( len9 ):
                transall.append( replaceLastofwith( transall[ i ], "ei", toi3 ) )
            
        #transform letters ai -> e # ai -> ae
        if( "ai" in awordlowerd ):
            len10 = len( transall ) 
            for i in range( len10 ):
                transall.append( replaceLastofwith( transall[ i ], "ai", toe8 ) )
                transall.append( replaceLastofwith( transall[ i ], "ai", toae9 ) )
            
        #transform letters c -> k # C -> K
        if( "c" in awordlowerd ):
            len11 = len( transall )
            for i in range( len11 ): 
                transall.append( transall[ i ].replace( fromc9, tok10 ).replace( fromC9, toK10 ) )

        #uppercase for all??
        len12 = len( transall )
        for i in range( len12 ): 
            transall.append( transall[ i ].upper( ) )
               
        #first letter upper case to all
        len13 = len( transall )
        for i in range( len13 ): 
            transall.append( capitali( transall[ i ] ) )
        
        #print("fetzig", aword, len(transall))
        transallALL = transallALL + transall 
...
def simplekon( aDaaA ):
    ...
    lenofall = len( aDaaA )
    for aw in range( lenofall ):
        cleanedword = aDaaA[ aw ].strip( )
        
        if( cleanedword in simplekonkordanz ): 
...
def schaneigh( simplekonkordanz, aDaaA ):
    neighbournoonelovesyou = {}
    ...
    for aw in range( lenofall ):
        ...
        #print(cleanedword, simplekonkordanz[ cleanedword ], cleanedword != "",
        #    simplekonkordanz[ cleanedword ] <= howmuchhaufisselten,
        #    not hasKEY( stopGR, cleanedword.lower() ), 
        #    not hasKEY( stopLA, cleanedword.lower() ), 
        #    not textnorm.isnumber( cleanedword ))
        if( cleanedword != "" and 
            simplekonkordanz[ cleanedword ] <= howmuchhaufisselten and
            not hasKEY( stopGR, cleanedword.lower() ) and 
            not hasKEY( stopLA, cleanedword.lower() ) and 
            not textnorm.isnumber( cleanedword ) ):
                #print(cleanedword)
                #nachbarschaft
                nachba = []
                st = aw-(int(nachbarschaft/2)+1)
                if( st < 0 ):
                    st = 0
                
                count = 0
                while( count < nachbarschaft and st < lenofall ):
                    naba = aDaaA[st].strip( )
                    nabamore = textnorm.normatext( naba, textnorm.analysisNormalform ).lower()
                    if( not ( not "-" in naba and st == lenofall-1) and 
                        ( naba != "" and st != aw and not hasKEY(stopGR, nabamore) and not hasKEY(stopLA, nabamore) and not textnorm.isnumber( nabamore ) ) ):
                        nachba.append( naba )
                        count += 1
                    st+=1
...
def fnb( texttt ):
    aDaa = textnorm.normatext( textnorm.sameallspacing(texttt), textnorm.analysisNormalform )
    aDaaA = textnorm.Trennstricheraus( textnorm.deledklammern( textnorm.disambiguadashes( aDaa )).split(" ") )
    stringggg = textnorm.delUnterpunkt( textnorm.umbrtospace( " ".join( aDaaA ) ) )#?
    stringggg = textnorm.sigmaistgleich( textnorm.deluv( textnorm.delligaturen( textnorm.delinterp( textnorm.delmakup( textnorm.delumbrbine( textnorm.delnumbering( textnorm.delunknown( stringggg  ))))))))    
    aDaaA = stringggg.split(" ")
    for w in range( len( aDaaA ) ):
        if( isupper( aDaaA[ w ] )):
            aDaaA[ w ] = textnorm.capitali( aDaaA[ w ] )
...
def zerl():
    ...
    gugu = {}
    for p in stopGR:
        gugu[textnorm.sigmaistgleich(p)] = stopGR[p]
    stopGR = gugu

    if( textnorm.doUVlatin ):
        gugu = {}
        for p in stopLA:
            gugu[ textnorm.deluv(p) ] = stopLA[p] 
        stopLA = gugu
    ...
    aswords = stristrstrung.split( " " )

    Strout += "--3 gram gesamter Text:--\n"
    Strout += "/ ".join( ngramWhole( stristrstrung, 3 ) ) +"\n\n"

    Strout += "--2 gram gesamter Text:--\n"
    Strout += "/ ".join( ngramWhole( stristrstrung, 2 ) ) +"\n\n"

    Strout += "--3 gram der Wörter nopadding:--\n"
    output = ngramWords( aswords, 3, False )
    for f in range( len( output )):
        Strout += "/ ".join(output[f])+", "
    Strout += "\n\n\n "

    Strout += "--3 gram der Wörter padding:--\n"
    output = ngramWords( aswords, 3, True )
    for f in range( len( output )):
        Strout += "/ ".join(output[f])+", "
    Strout += "\n\n\n "

    Strout += "--2 gram der Wörter padding:--\n"
    output = ngramWords( aswords, 2, True )
    for f in range( len( output )):
        Strout += "/ ".join(output[f])+", "
    Strout += "\n\n\n "
    ...
    tempstr = ""
    perwordpartionined = toKKCnSufixWords( aswords )
    for w in range(len( perwordpartionined)):
        for b in range(len(perwordpartionined[w])):
            tempstr += "Ko: " + perwordpartionined[w][b][0] +" Koe: "+ perwordpartionined[w][b][1] +" Co: " +perwordpartionined[w][b][2]+" \n "
    ...
    stringtobeout = ""
    gutgemacht = fnb( stristrstrung )
    #print(gutgemacht)
    for vv in gutgemacht:
        #print(vv,gutgemacht[vv][0])
        strighgsjhsj = ""
        for uuu in gutgemacht[vv][0]:
            strighgsjhsj+= uuu+":"+str(gutgemacht[vv][0][uuu])+","
        
        stringtobeout = stringtobeout + vv +": ["+str(gutgemacht[vv][1])+", ["+strighgsjhsj+"]]\n"
    
    Strout += stringtobeout+"\n\n"
